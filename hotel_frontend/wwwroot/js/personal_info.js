    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        "Vietnam": ["Ho Chi Minh", "Ha Noi", "Bien Hoa", "Cam Ranh", "Hue", "Thu Dau Mot", "Quang Ngai", "Da Lat", "Nha Trang", "Vinh", "Ba Ria - Vung Tau"],
    ...
    confirmEmail.classList.add('invalid-input');
            } else {
        emailError.style.display = 'none';
    confirmEmail.classList.remove('invalid-input');
            }
    checkFormValidity();
        }

    function checkFormValidity() {
            const isValid = form.checkValidity() && email.value === confirmEmail.value;
